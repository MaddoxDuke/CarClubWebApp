    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_carEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_carEvents_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_carEvents_AppUser_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUser",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_carEvents_AddressId",
                table: "carEvents",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_carEvents_AppUserId",
                table: "carEvents",
                column: "AppUserId");
        }
